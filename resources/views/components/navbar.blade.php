...
<nav id="main-navbar"
    ...
    <div class="flex items-center">
        <div class="flex flex-col items-center mr-4 md:mr-8">
            ...
            <div class="relative">
                <img src="/img/logo-white-brp.png" alt="Logo" class="h-6 md:h-7 w-auto transition-opacity duration-300"
                    id="logo-white">
                <img src="/img/logo-brp.png" alt="Logo"
                    class="h-6 md:h-7 w-auto transition-opacity duration-300 absolute top-0 left-0 opacity-0"
                    id="logo-dark">
            </div>
            <span class="font-bold text-[8px] md:text-[11px] text-yellow-400 text-center leading-tight">Bangun Rumah
                Project</span>
        </div>
    ...
    <button id="main-burger-btn"
        class="md:hidden mobile-menu-btn bg-transparent text-yellow-400 p-2 rounded-lg hover:bg-white/20 transition-all duration-300 flex flex-col justify-center items-center w-10 h-10">
    ...
    <div class="mobile-menu-content">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-700">
            ...
            <button id="close-burger-btn"
                class="mobile-close-btn bg-white text-black p-2 rounded-lg shadow-lg hover:bg-gray-100 transition-all duration-300 flex flex-col justify-center items-center w-10 h-10">
