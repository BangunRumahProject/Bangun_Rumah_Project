...
@section('title', 'Jasa Desain Interior & Eksterior Rumah di Kendari Sulawesi Tenggara')
@section('meta_description', 'Jasa desain interior dan eksterior rumah di Kendari Sulawesi Tenggara. Konsep estetis, fungsional, dan sesuai budget. Arsitek profesional untuk rumah impian Anda.')
...
@section('content')
    ...
    <body class="bg-black font-sans">
        ...
        <section class="relative w-full min-h-screen bg-gray-900 overflow-hidden">
            ...
            <div class="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-80 pt-20"
                style="background-image: url('{{ asset('img/profil5.png') }}');">
            </div>
            <div class="absolute inset-0 bg-gradient-to-r from-black/30 via-black/50 to-black/30"></div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-12 pt-24">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
                    ...
                    <div class="space-y-6 fade-in mt-[-10px] ml-10">
                        <!-- Main Title -->
                        <div class="space-y-4">
                    ...
                    <div class="space-y-8 fade-in">
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm lg:text-base leading-relaxed max-w-lg">
                                Kami menawarkan layanan renovasi rumah yang berkualitas tinggi dengan tim profesional,
                                material premium, dan pelayanan yang memuaskan.
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 slide-in-right">
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                Tim ahli kami terdiri dari arsitek, insinyur, dan tukang berpengalaman yang telah
                                mengerjakan berbagai proyek renovasi berkualitas tinggi.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                Kami menggunakan material berkualitas tinggi dan terbaik untuk memastikan hasil renovasi
                                yang tahan lama dan memuaskan.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                Tim desainer kami menghadirkan konsep dan desain renovasi yang inovatif, modern, dan sesuai
                                dengan tren terkini.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                Kami berkomitmen memberikan pelayanan renovasi yang cepat, responsif, dan sesuai dengan
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                Kami menawarkan harga yang kompetitif dan terjangkau tanpa mengorbankan kualitas hasil
                                renovasi.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed">
                                Kami memberikan garansi komprehensif untuk semua pekerjaan renovasi dan siap memperbaiki
                                jika ada masalah dalam masa garansi.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-16 fade-in">
                        ...
                        <div class="mb-16">
                            <h2 class="text-black text-3xl font-normal leading-relaxed">
                                Tahap Menggunakan Jasa<br>Desain Interior & Eksterior
                            </h2>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-x-16 gap-y-12">
                            ...
                            <div class="space-y-4">
                                ...
                                <h3 class="text-black text-xl font-semibold">Konsultasi & Briefing</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Memahami kebutuhan, gaya, budget, dan ruang lingkup pekerjaan untuk interior/eksterior.
                                </p>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <h3 class="text-black text-xl font-semibold">Survey & Pengukuran</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Kunjungan lokasi, dokumentasi, dan pengukuran detail sebagai dasar perancangan.
                                </p>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <h3 class="text-black text-xl font-semibold">Desain 3D & RAB</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Pembuatan konsep desain 2D/3D beserta estimasi anggaran dan revisi hingga disetujui.
                                </p>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <h3 class="text-black text-xl font-semibold">Produksi, Instalasi & Serah Terima</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Fabrikasi/produksi, pemasangan di lokasi, quality control, dan serah terima bergaransi.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-yellow-400 to-yellow-300 rounded-2xl p-12 text-center">
                    <h2 class="text-3xl lg:text-4xl font-bold text-black mb-6">
                        Ubah Rumah <span class="font-normal">Impian</span> Anda Jadi <span
                            class="font-normal">Kenyataan.</span>
                    </h2>
                    <p class="text-black text-lg mb-12 max-w-3xl mx-auto">
                        Dengan dukungan teknologi modern, setiap proses desain interior dapat divisualisasikan terlebih
                        dahulu sebelum dieksekusi.
                        Hal ini memudahkan pengerjaan sekaligus memastikan konsep yang dihasilkan sesuai dengan harapan
                        klien.
                    </p>
                        ...
                        <div class="space-y-4" id="services-accordion-layanan3">
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan3 px-6 pb-4 text-gray-600 leading-relaxed"
                                    ...
                                    <ul class="list-disc list-inside space-y-2 text-sm">
                                        ...
                                        <li><strong>Material yang Digunakan:</strong> Material premium mempengaruhi harga
                                        </li>
                                    </ul>
                                    <p class="mt-3">Kami akan memberikan penawaran detail setelah konsultasi dan survey
                                        lokasi.</p>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan3 px-6 pb-4 text-gray-600 leading-relaxed"
                                    ...
                                    <ul class="list-disc list-inside space-y-2 text-sm">
                                        <li><strong>Paket Ekonomis:</strong> Desain sederhana dengan material terjangkau
                                        </li>
                                        <li><strong>Paket Standard:</strong> Desain menengah dengan material berkualitas
                                        </li>
                                    ...
                                    <p class="mt-3">Tim kami akan memberikan alternatif desain yang sesuai dengan
                                        anggaran Anda.</p>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan3 px-6 pb-4 text-gray-600 leading-relaxed"
                                    ...
                                    <p class="mt-3">Kami akan menciptakan desain eksterior yang harmonis dengan
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan3 px-6 pb-4 text-gray-600 leading-relaxed"
                                    ...
                                    <ul class="list-disc list-inside space-y-2 text-sm">
                                        ...
                                        <li><strong>Konsultasi Revisi:</strong> Diskusi langsung untuk memahami perubahan
                                        </li>
                                    ...
                                    <p class="mt-3">Tim kami akan bekerja keras memastikan desain sesuai dengan visi dan
                                        kebutuhan Anda.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        button.addEventListener('click', function() {
                            ...
                            if (content.style.display === 'block') {
                                ...
                                if (currentlyOpen) {
                                    ...
                                    currentlyOpen.closest('.border').querySelector('.service-icon-layanan3')
