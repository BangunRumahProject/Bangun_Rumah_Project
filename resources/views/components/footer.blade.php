<footer class="bg-black text-white pt-12 pb-4">
    <div class="max-w-6xl mx-auto px-4">
        <!-- Logo dan Nama Perusahaan - Centered -->
        <div class="flex flex-col items-center mb-8">
            <img src="/img/logo-white-brp.png" alt="Logo" class="h-16 mb-2">
            <div class="font-bold text-lg text-yellow-400">Bangun Rumah Project</div>
        </div>
