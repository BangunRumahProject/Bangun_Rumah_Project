...
@section('meta_description', 'Jasa bangun dan renovasi rumah di Kendari: pengerjaan rapi, material berkualitas, timeline jelas, dan anggaran transparan di Kendari. Dapatkan penawaran gratis.')
...
@section('content')
    ...
    <body class="bg-black font-sans">
        ...
        <section class="relative w-full min-h-screen bg-gray-900 overflow-hidden">
            ...
            <div class="absolute inset-0 bg-cover bg-top bg-no-repeat opacity-80"
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-16">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">

                    <!-- Left Content - Text Section -->
                    <div class="space-y-6 fade-in mt-8 ml-10">
                        <!-- Main Title -->
                        <div class="space-y-4">
        ...
        <section class="relative w-full bg-gray-100 text-black py-20">
            <div class="max-w-7xl mx-auto px-8">
                <div class="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <!-- Right Content - Steps -->
                    <div class="space-y-16 slide-in-right">
                        <!-- Main Title -->
                        <div class="mb-16">
                            <h2 class="text-black text-3xl font-normal leading-relaxed">
                        ...
                        <div class="space-y-4" id="services-accordion-layanan1">
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                <button type="button"
                                    ...
                                    <svg class="service-icon-layanan1 w-6 h-6 transform transition-transform duration-300 text-yellow-600"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                <div class="service-content-layanan1 px-6 pb-4 text-gray-600 leading-relaxed"
                                    style="display: none;">
                                    <p class="mb-3">Waktu pengerjaan pembangunan rumah bervariasi tergantung:</p>
                                    <ul class="list-disc list-inside space-y-2 text-sm">
                                        <li><strong>Ukuran Bangunan:</strong> Rumah sederhana 3-6 bulan, rumah mewah 8-18
                                            bulan</li>
                                        <li><strong>Kompleksitas Desain:</strong> Desain custom membutuhkan waktu lebih lama
                                        </li>
                                        <li><strong>Kondisi Tanah:</strong> Tanah lunak memerlukan pondasi khusus</li>
                                        <li><strong>Cuaca:</strong> Musim hujan bisa memperlambat proses</li>
                                    </ul>
                                    <p class="mt-3">Tim kami akan memberikan timeline yang akurat setelah survey lokasi
                                        dan finalisasi desain.</p>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan1 px-6 pb-4 text-gray-600 leading-relaxed"
                                    style="display: none;">
                                    <p class="mb-3">Ya, kami memberikan garansi komprehensif untuk semua pekerjaan:</p>
                                    <ul class="list-disc list-inside space-y-2 text-sm">
                                        <li><strong>Garansi Struktur:</strong> 10 tahun untuk pondasi dan struktur utama
                                        </li>
                                        <li><strong>Garansi Finishing:</strong> 2 tahun untuk pekerjaan finishing</li>
                                        <li><strong>Garansi Instalasi:</strong> 1 tahun untuk listrik, air, dan sanitasi
                                        </li>
                                        <li><strong>Garansi Material:</strong> Sesuai garansi pabrik material</li>
                                    </ul>
                                    <p class="mt-3">Kami berkomitmen memberikan kualitas terbaik dan siap memperbaiki
                                        jika ada masalah dalam masa garansi.</p>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan1 px-6 pb-4 text-gray-600 leading-relaxed"
                                    style="display: none;">
                                    <p class="mb-3">Kami menerapkan sistem pembayaran bertahap yang transparan:</p>
                                    <ul class="list-disc list-inside space-y-2 text-sm">
                                        <li><strong>DP Awal:</strong> 30% saat kontrak ditandatangani</li>
                                        <li><strong>Pondasi:</strong> 20% setelah pondasi selesai</li>
                                        <li><strong>Struktur:</strong> 25% setelah struktur utama selesai</li>
                                        <li><strong>Finishing:</strong> 20% setelah finishing 80%</li>
                                        <li><strong>Serah Terima:</strong> 5% setelah serah terima</li>
                                    </ul>
                                    <p class="mt-3">Setiap tahap pembayaran akan didokumentasikan dan disertai laporan
                                        progress yang detail.</p>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan1 px-6 pb-4 text-gray-600 leading-relaxed"
                                    ...
                                    <p class="mt-3">Kami memastikan setiap anggota tim memiliki kompetensi yang sesuai
                                        dengan standar industri konstruksi.</p>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-300 rounded-lg">
                                ...
                                <div class="service-content-layanan1 px-6 pb-4 text-gray-600 leading-relaxed"
                                    ...
                                    <p class="mt-3">Kami berkomitmen menyelesaikan setiap masalah dengan cepat dan
                                        profesional untuk memastikan proyek tetap berjalan lancar.</p>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            // Services Accordion functionality for Layanan1 page
            document.addEventListener('DOMContentLoaded', function() {
                const serviceButtons = document.querySelectorAll('.service-button-layanan1');
                    ...
                    button.addEventListener('click', function() {
                        ...
                        if (content.style.display === 'block') {
                            ...
                            if (currentlyOpen) {
                                ...
                                currentlyOpen.closest('.border').querySelector('.service-icon-layanan1')
