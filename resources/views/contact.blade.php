...
@section('title', 'Kontak Bangun Rumah Project - Kontraktor di Kendari Sulawesi Tenggara')
@section('meta_description', 'Hubungi Bangun Rumah Project di Kendari Sulawesi Tenggara untuk konsultasi gratis bangun/renovasi rumah, pembuatan RAB, PBG/IMB, dan desain arsitektur.')
                        ...
                        <div class="text-white">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <a href="https://web.facebook.com/profile.php?id=61554534025479" class="text-white hover:text-yellow-400 transition duration-300"
                                    aria-label="Facebook"
                                    class="text-white hover:text-yellow-400 transition duration-300"
                                    target="_blank" rel="noopener">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="https://www.youtube.com/@bangunrumahproject" aria-label="youtube" class="text-white hover:text-yellow-400 transition duration-300" target="_blank" rel="noopener">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                            <path
